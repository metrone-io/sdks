...
export default function Home() {
  ...
  return (
    <div className="container">
      <h1>Metrone Analytics - Next.js Example</h1>
      
      <p>This example demonstrates how to use Metrone Analytics with Next.js and React.</p>
...
NEXT_PUBLIC_METRONE_API_KEY=metrone_live_xxx
NEXT_PUBLIC_METRONE_ENDPOINT=https://api.metrone.io/v1/events`}
        </pre>
      </div>
